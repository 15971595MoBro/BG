...
<head>
    <title>ic-demos.com email Contact US</title>
...
<body dir="ltr">
    <form id="Form1">
    <!-- EditSection -->    <table id="Table1" align="center" border="0" cellpadding="0" cellspacing="0" width="800">
        <tbody>
            <tr>
                <td align="left" valign="top">
                    <img alt="" src="http://@@ServerName@@/images/Logo.png" height="183" width="402">
                </td>
            </tr>
            <tr>
                <td valign="top">
                        ...
                        <tbody>
                            <tr>
                                <td class="titleBg" valign="top">
                                    <h1>
                                        Subject: <span class="style1">User Contact</span>
                                    </h1>
                                </td>
                            </tr>
                            <tr>
                                                ...
                                                <td align="center">
                                                    <table id="Table14" border="0" cellpadding="1" cellspacing="1" width="85%">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                <td id="TDEmail" align="right" width="25%">
                                                                    <h6>
                                                                        E-mail</h6>
                                                                </td>
                                                                <td width="5%">
                                                     ...
                                                     <tr>
                                                                <td id="TD22" align="right" width="25%">
                                                                    <h6>
                                                                        Country</h6>
                                                                </td>
                                                                <td width="5%">
            ...
            <tr>
                <td class="horSeparetor" valign="top">
                    <img alt="" src="http://@@ServerName@@/images/spacer.gif" height="1" width="1">
                </td>
            </tr>
            <tr>
                <td class="footer m7" valign="top">
                    <div align="right">
                        Copyright &#169; 2018 BGBeauty. All Rights Reserved.
                    </div>
                </td>
            </tr>
            <tr>
                <td class="footer m7" valign="top">
                    <div align="right">
                        <a href="http://@@ServerName@@/">BGBeauty</a>
                    </div>
                </td>
            </tr>
        </tbody>
