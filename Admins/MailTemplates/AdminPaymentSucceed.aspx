...
<head>
    <title>Shopping Cart Payment Succeed</title>
    <style type="text/css">
        BODY
        {
            font-family: tahoma;
        ...
        <tbody>
                            ...
                            <td class="tm20 bm10" valign="top">
                                <table cellspacing="1" cellpadding="1" width="100%" border="0">
                                    <tr>
                                        <td>
                                            <p>
                                                User @@Name@@ payment succeed with order number: @@OrderNumber@@,</p>
                                            <p>
                                                Update his/her shipping status.</p>
                                            <p>
                                                You can check his/her order details by visit this link: http://@@ServerName@@/Admins/ShoppingcartEdit.aspx?ID=@@ShoppingCartID@@
                                            </p>
                                        </td>
                                    </tr>
                                    <tr>
            ...
            <tr>
                <td class="footer m7" valign="top">
                    <div align="right">
                        Copyright &#169; 2008 BGBeauty. All Rights Reserved.
                    </div>
                </td>
            </tr>
        </tbody>
