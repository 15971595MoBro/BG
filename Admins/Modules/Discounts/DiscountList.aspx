<%@ Page Title="Discount List" Language="C#" MasterPageFile="~/Admins/AdminMaster.Master" AutoEventWireup="true" CodeBehind="DiscountList.aspx.cs" Inherits="BGBeautyProject_Website.Admins.Modules.Discounts.DiscountList" %>
            ...
            <div class="portlet light bordered ">
                <div class="portlet-title">
                    <div class="caption font-dark">
                        ...
                        <span class="caption-subject bold uppercase">Discount List</span>
                    </div>
                    <div class="tools">
                ...
                <div class="portlet-body">
                    <div class="table-toolbar">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="btn-group">
                                    <a class="btn btn-success btn-sm btn-block" href='<%= "/Admins/Modules/Discounts/DiscountAddEdit"%>' aria-expanded="false">New Discount
                                    </a>
                                </div>
                            </div>
                            <%--<div class="col-md-6">
                    ...
                    <table id="Tbl_UsersList" class="table table-striped table-bordered table-hover order-column">
                        ...
                        <tbody id="Tbody_DiscountList">
                            <asp:Repeater ID="Repeater_DiscountList" runat="server">
                                <ItemTemplate>
                                    <tr>
                                        <th>
                                            <%# Eval("DiscountName", "{0}")%>
                                        ...
                                        <th>
                                            <%# Eval("StartDate","{0:dd-MMMM-yyyy}") %>
                                        </th>

                                        <th>
                                            <%# Eval("EndDate","{0:dd-MMMM-yyyy}") %>
                                        </th>
