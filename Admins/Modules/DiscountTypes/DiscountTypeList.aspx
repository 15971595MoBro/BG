<%@ Page Title="Discount Type List" Language="C#" MasterPageFile="~/Admins/AdminMaster.Master" AutoEventWireup="true" CodeBehind="DiscountTypeList.aspx.cs" Inherits="BGBeautyProject_Website.Admins.Modules.DiscountTypes.DiscountTypeList" %>
            ...
            <div class="portlet light bordered ">
                <div class="portlet-title">
                    <div class="caption font-dark">
                        ...
                        <span class="caption-subject bold uppercase">Discount Type List</span>
                    </div>
                    <div class="tools">
                ...
                <div class="portlet-body">
                    <div class="table-toolbar">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="btn-group">
                                    <a class="btn btn-success btn-sm btn-block" href='<%= "/Admins/Modules/DiscountTypes/DiscountTypeAddEdit"%>' aria-expanded="false">New Discount Type
                                    </a>
                                </div>
                            </div>
                            <%--<div class="col-md-6">
                    ...
                    <table id="Tbl_UsersList" class="table table-striped table-bordered table-hover order-column">
                        ...
                        <tbody id="Tbody_CustomersList">
                            <asp:Repeater ID="Repeater_DiscountTypeList" runat="server">
                                <ItemTemplate>
                                    <tr>
                                        <%--<th>
                                        ...
                                        <th>
                                            <%# Eval("DiscountTypeName", "{0}")%>
                                        </th>

                                        <th>
                                            <%# Eval("DiscountTypeBrief","{0}") %>
                                        </th>

                                        <th class="text-center">
                                            <%# Eval("Active", "{0}") == "True" ? "<li class='fa fa-check font-green'></li>" :  "<li class='fa fa-close font-red'></li>"%>
                                        </th>
                                        <th>
                                            <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl='<%# "/Admins/Modules/DiscountTypes/DiscountTypeAddEdit?id=" + Eval("DiscountTypeUID", "{0}")%>'><li class='fa fa-edit '></li> Edit</asp:HyperLink>
                                        </th>
                                    </tr>
                                </ItemTemplate>
                            </asp:Repeater>
