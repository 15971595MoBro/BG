<%@ Page Title="" Language="C#" MasterPageFile="~/Admins/AdminMaster.Master" AutoEventWireup="true" CodeBehind="CustomerList.aspx.cs" Inherits="BGBeauty_Website.Admins.Modules.Customers.CustomerList" %>
                ...
                <div class="portlet-body">
                    <div class="table-toolbar">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="btn-group">
                                    <a class="btn btn-success btn-sm btn-block" href='<%= "/Admins/Modules/Customers/CustomerAddEdit"%>' aria-expanded="false">New Customer
                                    </a>
                                </div>
                            </div>
                            <%--<div class="col-md-6">
                    ...
                    <table id="Tbl_UsersList" class="table table-striped table-bordered table-hover order-column">
                        ...
                        <tbody id="Tbody_CustomersList">
                            <asp:Repeater ID="Repeater_CustomerList" runat="server">
                                <ItemTemplate>
                                    <tr>
                                        <%--<th>
                                        ...
                                        <th>
                                            <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl='<%# "/Admins/Modules/Customers/CustomerAddEdit?id=" + Eval("Id", "{0}")%>'><li class='fa fa-edit '></li> Edit</asp:HyperLink>
                                        </th>
                                    </tr>
                                </ItemTemplate>
                            </asp:Repeater>
