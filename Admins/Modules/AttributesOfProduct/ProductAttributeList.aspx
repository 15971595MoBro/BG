<%@ Page Title="Product attributes" Language="C#" MasterPageFile="~/Admins/AdminMaster.Master" AutoEventWireup="true" CodeBehind="ProductAttributeList.aspx.cs" Inherits="BGBeauty_Website.Admins.Modules.AttributesOfProduct.ProductAttributeList" %>
            ...
            <div class="portlet light bordered ">
                <div class="portlet-title">
                    <div class="caption font-dark">
                        ...
                        <span class="caption-subject bold uppercase">attributes List</span>
                    </div>
                    <div class="tools">
                ...
                <div class="portlet-body">
                    <div class="table-toolbar">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="btn-group">
                                    <a class="btn  btn-success btn-sm btn-block" href="/Admins/Modules/AttributesOfProduct/ProductAttributeAddEdit" aria-expanded="false">New attribute
                                    </a>
                                </div>
                            </div>
                            <%--<div class="col-md-6">
                            ...
                            <asp:Repeater ID="Repeater_attributesList" runat="server">
                                <ItemTemplate>
                                    <tr>
                                        ...
                                        <th>
                                            <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl='<%# "ProductAttributeAddEdit?id=" + Eval("Id", "{0}")%>'><li class='fa fa-edit '></li> Edit</asp:HyperLink>
                                        </th>
                                    </tr>
                                </ItemTemplate>
                            </asp:Repeater>
