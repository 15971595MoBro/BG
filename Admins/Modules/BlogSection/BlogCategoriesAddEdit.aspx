<%@ Page Title="Categories Add/Edit" Language="C#" MasterPageFile="~/Admins/AdminMaster.Master" AutoEventWireup="true" CodeBehind="BlogCategoriesAddEdit.aspx.cs" Inherits="BGBeautyProject_Website.Admins.Modules.BlogSection.BlogCategoriesAddEdit" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="Content_MapPath" runat="server">
        ...
        <li><a href="BlogCategoriesList.aspx">Categories</a><i class="fa fa-circle"></i></li>
        <li class="active">
            <%: Title %></li>
    </ul>
</asp:Content>
                ...
                <div class="portlet-body form">
                    <div class="col-sm-12">
                        <div class=" portlet-input pull-right margin-bottom-20">
                            ...
                            &nbsp;
                              <a class="btn btn-s-md btn-default btn-rounded" href="CategoriesList.aspx">Cancel</a>
                    ...
                    <div class="panel-body">
                        ...
                        <div class="col-sm-8">
                            <div class="form-group pull-in clearfix">
                                <label>
                                    Category Name
                            <asp:RequiredFieldValidator ID="RequiredFieldValidatorCategoryName" runat="server" ForeColor="Red"
                                ControlToValidate="TxtCategoryName" ErrorMessage="*" SetFocusOnError="True"></asp:RequiredFieldValidator></label>
                                <asp:TextBox ID="TxtCategoryName" runat="server" Text="" class="form-control" placeholder="Category Name"></asp:TextBox>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-8">
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ForeColor="Red"
                                ControlToValidate="TxtHttpUrl" ErrorMessage="*" SetFocusOnError="True"></asp:RequiredFieldValidator></label>
                                <asp:TextBox ID="TxtHttpUrl" runat="server" Text="" class="form-control" placeholder="Http Url"></asp:TextBox>
                            </div>
                        </div>
