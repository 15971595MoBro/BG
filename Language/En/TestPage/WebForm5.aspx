<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WebForm5.aspx.cs" Inherits="BGBeautyProject_Website.Language.En.TestPage.WebForm5" %>
...
<head>
    ...
    <!--== Bootstrap CSS ==-->
    <link href="/App_Themes/assets/css/bootstrap.min.css" rel="stylesheet" />
    <!--== Font Awesome Min Icon CSS ==-->
    <link href="/App_Themes/assets/css/font-awesome.min.css" rel="stylesheet" />
    <!--== 7 Stroke Icon CSS ==-->
    <link href="/App_Themes/assets/css/pe-icon-7-stroke.css" rel="stylesheet" />
    <!--== Swiper CSS ==-->
    <link href="/App_Themes/assets/css/swiper.min.css" rel="stylesheet" />
    <!--== Fancybox Min CSS ==-->
    <link href="/App_Themes/assets/css/fancybox.min.css" rel="stylesheet" />
    <!--== Range Slider Min CSS ==-->
    <link href="/App_Themes/assets/css/ion.rangeSlider.min.css" rel="stylesheet" />
...
<div class="wrapper">
          ...
          <div class="header-align">
            <div class="header-align-start">
              <div class="header-logo-area">
                <a href="index.html">
                  <img class="logo-main" src="assets/img/BGBeauty.png" width="158"  alt="Logo" />
                </a>
              </div>
            </div>
  ...
  <main class="main-content">
                    ...
                    <div class="col-sm-8 col-md-6">
                      <div class="slider-content">
                        <div class="content">
                          ...
                          <div class="desc-box">
                            <p class="desc">Lorem ipsum dolor sit amet, consectetur adipisicing elit, seddo do eiusmod tempor incidid ut labore.</p>
                          </div>
                          <div class="btn-box">
    ...
    <div class="feature-area feature-style2-area">
      <div class="container">
        <div class="row">
      ...
      <div class="container pt--0">
        <div class="row">
          <div class="col-md-6 col-lg-6">
            <div class="banner-product-single-style3-item">
              <div class="thumb">
                <a href="shop.html">
                  <img src="assets/img/shop/banner/4.webp" width="370" height="247" alt="Image-HasTech">
                </a>
              </div>
              <div class="content">
                <h5 class="sub-title">-25%  Off </h5>
                <h5 class="title">Dog Dry Food & Medicine</h5>
          ...
          <div class="col-md-6 col-lg-6">
            <div class="banner-product-single-style3-item">
              <div class="thumb">
                <a href="shop.html">
                  <img src="assets/img/shop/banner/5.webp" width="370" height="247" alt="Image-HasTech">
                </a>
              </div>
              <div class="content">
                <h5 class="sub-title">-25%  Off </h5>
                <h5 class="title">Cat Dry Food & Medicine</h5>
                <a class="btn-theme-link" href="shop.html">Shop Now</a>
              </div>
            </div>
          </div>
        ...
        <div class="row divider-style2">
          <div class="col-lg-6">
            <div class="divider-thumb">
              <img src="assets/img/photos/divider3.webp" width="595" height="523" alt="Image-HasTech">
            </div>
          </div>
          <div class="col-lg-6">
    ...
    <section class="blog-area blog-default-area">
      <div class="container">
        <div class="row">
          <div class="col-12"> <div class="section-title shape-center text-center">
              <h5 class="sub-title">News & Latest</h5>
...
<!--=======================Javascript============================-->
    ...
    <!--=== jQuery Modernizr Min Js ===-->
        <script src="/App_Themes/assets/js/modernizr.js"></script>
        <!--=== jQuery Min Js ===-->
        <script src="/App_Themes/assets/js/jquery-main.js"></script>
        <!--=== jQuery Migration Min Js ===-->
        <script src="/App_Themes/assets/js/jquery-migrate.js"></script>
        <!--=== jQuery Popper Min Js ===-->
        <script src="/App_Themes/assets/js/popper.min.js"></script>
        <!--=== jQuery Bootstrap Min Js ===-->
        <script src="/App_Themes/assets/js/bootstrap.min.js"></script>
        <!--=== jQuery Swiper Min Js ===-->
        <script src="/App_Themes/assets/js/swiper.min.js"></script>
        <!--=== jQuery Fancybox Min Js ===-->
        <script src="/App_Themes/assets/js/fancybox.min.js"></script>
        <!--=== jQuery Countdown Min Js ===-->
        <script src="/App_Themes/assets/js/countdown.js"></script>
        <!--=== jQuery Isotope Min Js ===-->
        <script src="/App_Themes/assets/js/isotope.pkgd.min.js"></script>
        <!--=== jQuery Range Slider Min Js ===-->
        <script src="/App_Themes/assets/js/ion.rangeSlider.min.js"></script>

        <!--=== jQuery Custom Js ===-->
        <script src="/App_Themes/assets/js/custom.js"></script>
