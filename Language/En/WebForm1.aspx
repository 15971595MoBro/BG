<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WebForm1.aspx.cs" Inherits="BGBeauty_Website.Language.En.WebForm1" %>
...
<head runat="server">
    ...
    <title>Jesco - Fashoin BGBeauty HTML Template</title>
    <meta name="description" content="Jesco - Fashoin BGBeauty HTML Template" />
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no" />

    <!-- Add site Favicon -->
    <link rel="shortcut icon" href="/App_Themes/BGBeautyDesign/assets/images/favicon/favicon.ico" type="image/png">


    <!-- vendor css (Icon Font) -->
    <link rel="stylesheet" href="/App_Themes/BGBeautyDesign/assets/css/vendor/bootstrap.bundle.min.css" />
    <link rel="stylesheet" href="/App_Themes/BGBeautyDesign/assets/css/vendor/pe-icon-7-stroke.css" />
    <link rel="stylesheet" href="/App_Themes/BGBeautyDesign/assets/css/vendor/font.awesome.css" />

    <!-- plugins css (All Plugins Files) -->
    <link rel="stylesheet" href="/App_Themes/BGBeautyDesign/assets/css/plugins/animate.css" />
    <link rel="stylesheet" href="/App_Themes/BGBeautyDesign/assets/css/plugins/swiper-bundle.min.css" />
    <link rel="stylesheet" href="/App_Themes/BGBeautyDesign/assets/css/plugins/jquery-ui.min.css" />
    <link rel="stylesheet" href="/App_Themes/BGBeautyDesign/assets/css/plugins/nice-select.css" />
    <link rel="stylesheet" href="/App_Themes/BGBeautyDesign/assets/css/plugins/venobox.css" />
    ...
    <!-- Main Style -->
    <link rel="stylesheet" href="/App_Themes/BGBeautyDesign/assets/css/style.css" />
</head>
<body>
    ...
    <script src="/App_Themes/BGBeautyDesign/assets/js/vendor/jquery-migrate-3.3.2.min.js"></script>
    <script src="/App_Themes/BGBeautyDesign/assets/js/vendor/modernizr-3.11.2.min.js"></script>

    <!--Plugins JS-->
    <script src="/App_Themes/BGBeautyDesign/assets/js/plugins/swiper-bundle.min.js"></script>
    <script src="/App_Themes/BGBeautyDesign/assets/js/plugins/jquery-ui.min.js"></script>
    <script src="/App_Themes/BGBeautyDesign/assets/js/plugins/jquery.nice-select.min.js"></script>
    <script src="/App_Themes/BGBeautyDesign/assets/js/plugins/countdown.js"></script>
    <script src="/App_Themes/BGBeautyDesign/assets/js/plugins/scrollup.js"></script>
    <script src="/App_Themes/BGBeautyDesign/assets/js/plugins/jquery.zoom.min.js"></script>
    <script src="/App_Themes/BGBeautyDesign/assets/js/plugins/venobox.min.js"></script>
